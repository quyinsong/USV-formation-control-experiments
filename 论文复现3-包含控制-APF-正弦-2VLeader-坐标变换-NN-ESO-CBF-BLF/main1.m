...
for k=1:Ns
   ...
   if t == 0
      ...
      O1 = [50 30]'; O2 = [60 60]'; O3 = [70 85]'; O4 = [85 85]';
      RO1 = 2; RO2 = 2; RO3 = 2; RO4 = 2;
      R1_up = RO1+10;  R2_up = RO2+10; R3_up = RO3+10; R4_up = RO3+10; 
   ...
   % USV states update  
   [USV1.x,USV1.tau,USV1.f, USV1.zeta, USV1.emi, USV1.Gamma] = CS1tf( USV1.x0, USV1.tauc_etm, tauw, ts );
   [USV2.x,USV2.tau,USV2.f, USV2.zeta, USV2.emi, USV2.Gamma] = CS2tf( USV2.x0, USV2.tauc_etm, tauw, ts );
   [USV3.x,USV3.tau,USV3.f, USV3.zeta, USV3.emi, USV3.Gamma] = CS3tf( USV3.x0, USV3.tauc_etm, tauw, ts );
   [USV4.x,USV4.tau,USV4.f, USV4.zeta, USV4.emi, USV4.Gamma] = CS4tf( USV4.x0, USV4.tauc_etm, tauw, ts );
...
%    OP = [O1,O2,O3,O4];
   ...
   [od1,od2,od3,od4] = odetection(USVP,OP,RO_up);
   ...
   [ pi1,pi1_dot] = CMG1( eF1,pj1_dot,vsi1,di1, pi10,od1,ts );
   [ pi2,pi2_dot] = CMG2( eF2,pj2_dot,vsi2,di2, pi20,ts );
   [ pi3,pi3_dot] = CMG3( eF3,pj3_dot,vsi3,di3, pi30,ts );
   [ pi4,pi4_dot] = CMG4( eF4,pj4_dot,vsi4,di4, pi40,ts );
...
%    USV4.nu_tf_hat = [USV4.u_hat,USV4.v_bar_hat,USV4.nu_bar(2)]';
   ...
   xout(k,:) = [t,USV1.x', USV2.x', USV3.x', USV4.x', USV1.tau' USV2.tau' USV3.tau' USV4.tau',...
                USV1.tauc' USV2.tauc' USV3.tauc' USV4.tauc',z2_norm',tauw(1),tauw(2),tauw(3),pi1',pi2',pi3',pi4',pr1',pr2',...
