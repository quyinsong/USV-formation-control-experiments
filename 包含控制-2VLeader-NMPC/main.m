...
%    tauc4 = [2 0.5]';
   ...
   xrout(k,:) = [t,xd1',xd2',xd3',xd4',pr0',pr5',pr6',eTheta',Zn'];
...
%    tauw = [0 0 0]';
   ...
   % NMPC
   Q = 1*diag([0.5 0.5 0.5 20 20 1]);
   R = diag([0.05 0.05]);
   F = 1*diag([0.5 0.5 0.5 20 20 1]);
   if t == 0
   ...
   [USV1.U_k,J1,USV1.Xhat]=NMPC1(USV1.Xm,Xrm1,Q_bar,R_bar,USV1.Uk_1,N,tm,USV1.Nm,Ob);%Xhat为预测的轨迹
   [USV2.U_k,J2,USV2.Xhat]=NMPC2(USV2.Xm,Xrm2,Q_bar,R_bar,USV2.Uk_1,N,tm,USV2.Nm,Ob);%Xhat为预测的轨迹
   [USV3.U_k,J3,USV3.Xhat]=NMPC3(USV3.Xm,Xrm3,Q_bar,R_bar,USV3.Uk_1,N,tm,USV3.Nm,Ob);%Xhat为预测的轨迹
   [USV4.U_k,J4,USV4.Xhat]=NMPC4(USV4.Xm,Xrm4,Q_bar,R_bar,USV4.Uk_1,N,tm,USV4.Nm,Ob);%Xhat为预测的轨迹
   USV1.Uk_1 = USV1.U_k;
   USV1.tauc = USV1.U_k(1:2);
   USV2.Uk_1 = USV2.U_k;
   USV2.tauc = USV2.U_k(1:2);
   USV3.Uk_1 = USV3.U_k;
   USV3.tauc = USV3.U_k(1:2);
   USV4.Uk_1 = USV4.U_k;
   USV4.tauc = USV4.U_k(1:2);
