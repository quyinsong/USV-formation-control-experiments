function [nu_c,zeta1,zeta2,q,vartheta,Theta1o,Theta2o] = Guidance1( hi, R_psi, zi, pj_dot, nu_bar, t, ts)
...
% 预设性能
a1 = 5; b1 = 5; zeta1 = (1-0.4)*exp(-0.2*t)+0.4;
...
uc = varrho(1)+zeta1_dot*z1/zeta1-0.05*q1/vartheta1-...
    0.05*vartheta1*q1-Theta1*sign(vartheta1*q1);
rc = (varrho(2)+zeta2_dot*z2/zeta2-0.005*q2/vartheta2-...
    0.005*vartheta2*q2-Theta2*sign(vartheta2*q2))/hi(2,2);
