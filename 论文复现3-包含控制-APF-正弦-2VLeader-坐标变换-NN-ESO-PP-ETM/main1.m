...
% USV states
USV1.x0 = [0 0 0 35 -5 10*pi/180]';
USV2.x0 = [0 0 0 25 -6 90*pi/180]';
USV3.x0 = [0 0 0 10 -5 80*pi/180]';
...
%    [USV4.x,USV4.tau,USV4.f] = CS4( USV4.x0, USV4.tauc_etm, tau_w, ts);
   ...
   [pr1,pr1_dw,theta1,wl1] = virtualLeader1( pc, eF1_s, eL1, wl2, vs, ts );
   [pr2,pr2_dw,theta2,wl2] = virtualLeader2( pc, eF2_s, eL2, wl1, vs, ts );
...
%    pi4_dot = [x00_dot,y00_dot]';
   ...
   USV1.r_hat = USV1.nu_hat(3); USV2.r_hat = USV2.nu_hat(3); USV3.r_hat = USV3.nu_hat(3); USV4.r_hat = USV4.nu_hat(3);
   
   % Guidance
   
   [USV1.nu_c,zeta1,zeta2,q1,vartheta1,Thetau1,Thetar1] = Guidance1( hi, R_psi1, z2(1:2), pi1_dot, USV1.nu_hat, t, ts);
   [USV2.nu_c,zeta1,zeta2,q2,vartheta2,Thetau2,Thetar2] = Guidance2( hi, R_psi2, z2(3:4), pi2_dot, USV2.nu_hat, t, ts);
   [USV3.nu_c,zeta1,zeta2,q3,vartheta3,Thetau3,Thetar3] = Guidance3( hi, R_psi3, z2(5:6), pi3_dot, USV3.nu_hat, t, ts);
   [USV4.nu_c,zeta1,zeta2,q4,vartheta4,Thetau4,Thetar4] = Guidance4( hi, R_psi4, z2(7:8), pi4_dot, USV4.nu_hat, t, ts);
...
%    USV4.nu_tf_hat = [USV4.u_hat,USV4.v_bar_hat,USV4.nu_bar(2)]';
   ...
   [USV2.tauc,USV2.e_bar,USV2.zetahat] = nnctr2( USV2.nu_hat, USV2.nu_c, USV2.tau, USV2.tauc, USV2.Gamma,q2,vartheta2,USV2.zeta,ts );
   [USV3.tauc,USV3.e_bar,USV3.zetahat] = nnctr3( USV3.nu_hat, USV3.nu_c, USV3.tau, USV3.tauc, USV3.Gamma,q3,vartheta3,USV3.zeta,ts );
   [USV4.tauc,USV4.e_bar,USV4.zetahat] = nnctr4( USV4.nu_hat, USV4.nu_c, USV4.tau, USV4.tauc, USV4.Gamma,q4,vartheta4,USV4.zeta,ts );
...
%    USV1.tauc_etm = USV1.tauc_etm-USV1.zetahat;
%    USV2.tauc_etm = USV2.tauc_etm-USV2.zetahat;
%    USV3.tauc_etm = USV3.tauc_etm-USV3.zetahat;
%    USV4.tauc_etm = USV4.tauc_etm-USV4.zetahat;
   ...
   xout(k,:) = [t,USV1.x', USV2.x', USV3.x', USV4.x', USV1.tau' USV2.tau' USV3.tau' USV4.tau',...
                ...
                USV2.v_bar,USV3.v_bar,USV4.v_bar,USV1.zeta_bar',USV1.zetahat',USV1.e_bar',USV2.e_bar',USV3.e_bar',...
                USV4.e_bar',z2',zeta1,zeta2,Thetau1,Thetau2,Thetau3,Thetau4,Thetar1,Thetar2,Thetar3,Thetar4,USV1.r_hat,...
                USV2.r_hat,USV3.r_hat,USV4.r_hat];
...
yrange=[-20 20 140]; xrange = [-10 10 100];
...
plt9 = plot(pr1(:,2),pr1(:,1),'k-'); 
plt10 = plot(pr2(:,2),pr2(:,1),'k-'); 
...
for k=1:2000:Ns
    ...
    plot(pi1(k,2),pi1(k,1),'ms','Markersize',16); 
    plot(pi2(k,2),pi2(k,1),'ms','Markersize',16); 
    plot(pi3(k,2),pi3(k,1),'ms','Markersize',16); 
    plot(pi4(k,2),pi4(k,1),'ms','Markersize',16); 
    
    plot(pr1(k,2),pr1(k,1),'ko'); 
    plot(pr2(k,2),pr2(k,1),'ko'); 
    myPlotLine( pr1(k,:),pr2(k,:) );
end
...
% 生成子图 
axes('Position',[0.2,0.69,0.2,0.2]); 
% 绘制局部曲线图  
hold on
plt1 = plot(USV1.x(:,5),USV1.x(:,4),'r-'); 
plt2 = plot(USV2.x(:,5),USV2.x(:,4),'g-'); 
...
figure(2)
subplot(4,1,1),plot(t,USV1.tau(:,1),'r-');
h1 = ylabel('$$\tau_{u1}$$ (N)');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
subplot(4,1,2),plot(t,USV2.tau(:,1),'g-');
h1 = ylabel('$$\tau_{u2}$$ (N)');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
subplot(4,1,3),plot(t,USV3.tau(:,1),'b-');
h1 = ylabel('$$\tau_{u3}$$ (N)');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
subplot(4,1,4),plot(t,USV4.tau(:,1),'c-');
h1 = ylabel('$$\tau_{u4}$$ (N)');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
h1 = xlabel('time (s)');
...
figure(3)
subplot(4,1,1),plot(t,USV1.tau(:,2),'r-');
h1 = ylabel('$$\tau_{r1}$$ (Nm)');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
subplot(4,1,2),plot(t,USV2.tau(:,2),'g-');
h1 = ylabel('$$\tau_{r2}$$ (Nm)');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
subplot(4,1,3),plot(t,USV3.tau(:,2),'b-');
h1 = ylabel('$$\tau_{r3}$$ (Nm)');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
subplot(4,1,4),plot(t,USV4.tau(:,2),'c-');
h1 = ylabel('$$\tau_{r4}$$ (Nm)');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
h1 = xlabel('time (s)');
...
ylim([0 5]);
box on;
h1 = ylabel('Triggering instants of$$\ \tau_{ui}$$ (m/s)');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
axes('Position',[0.2,0.81,0.4,0.15]); % 生成子图 
hold on
for i = 1:Ns
    if Tk1(i,1)==1
        plot(t(i),0.5*Tk1(i,1),'rx');
...
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
h1 = ylabel('Triggering instants of$$\ \tau_{ri}$$ (m/s)');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
axes('Position',[0.2,0.31,0.4,0.15]); % 生成子图 
hold on
for i = 1:Ns
    if Tk1(i,2)==1
        plot(t(i),0.5*Tk1(i,2),'rx');
...
figure(10)
subplot(311),plot(t,USV1.x(:,1),'r-',t,USV1.uhat,'b--');
...
subplot(312),plot(t,USV1.v_bar,'r-',t,USV1.v_bar_hat,'b--');
...
subplot(313),plot(t,USV1.x(:,3),'r-',t,USV1.rhat,'b--');
h1 = legend('$$r_1$$','$$\hat{r}_1$$');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
h1 = ylabel('$$\hat{r}_1$$ (rad/s)');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
h1 = xlabel('time (m/s)');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
...
h1 = legend('$$D_{u1}$$','$$\hat{D}_{u1}$$');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
h1 = ylabel('$$\hat{D}_{u1}$$ (N)');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
axes('Position',[0.2,0.65,0.25,0.15]); % 生成子图   
plot(t,USV1.zeta_bar(:,1),'r-',t,USV1.zetahat(:,1),'b--'); % 绘制局部曲线图                        
xlim([0,3]); % 设置坐标轴范围  
ylim([-0.8,0.8]);
set(gca,'xTick',0:1:3);
...
h1 = legend('$$D_{r1}$$','$$\hat{D}_{r1}$$');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
h1 = ylabel('$$\hat{D}_{r1}$$ (Nm)');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
h1 = xlabel('time (m/s)');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
axes('Position',[0.2,0.175,0.25,0.15]); % 生成子图   
plot(t,USV1.zeta_bar(:,2),'r-',t,USV1.zetahat(:,2),'b--'); % 绘制局部曲线图                        
xlim([0,3]); % 设置坐标轴范围  
ylim([-0.8,0.8]);
set(gca,'xTick',0:1:3);
set(gca,'yTick',-0.8:0.4:0.8);
...
h1 = legend('$$s_{u1}$$','$$s_{u2}$$','$$s_{u3}$$','$$s_{u4}$$');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
...
set(h1,'FontWeight',fontweight);
axes('Position',[0.2,0.65,0.25,0.15]); % 生成子图   
plot(t,USV1.e_bar(:,1),'r-',t,USV2.e_bar(:,1),'b-',t,USV3.e_bar(:,1),'c-',t,USV4.e_bar(:,1),'m-'); % 绘制局部曲线图                        
xlim([0,20]); % 设置坐标轴范围  
ylim([-0.4,0.4]);
...
h1 = legend('$$s_{r1}$$','$$s_{r2}$$','$$s_{r3}$$','$$s_{r4}$$');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
...
set(h1,'FontWeight',fontweight);
axes('Position',[0.2,0.175,0.25,0.15]); % 生成子图   
plot(t,USV1.e_bar(:,2),'r-',t,USV2.e_bar(:,2),'b--',t,USV3.e_bar(:,2),'c-',t,USV4.e_bar(:,2),'m--'); % 绘制局部曲线图                        
xlim([0,3]); % 设置坐标轴范围  
ylim([-0.8,0.8]);
set(gca,'xTick',0:1:3);
set(gca,'yTick',-0.8:0.4:0.8);
...
figure(13)
plot(t,z2(:,1),'r-',t,z2(:,3),'b-',t,z2(:,5),'g-',t,z2(:,7),'c-'); hold on 
plot(t,-5*zeta1,'k--',t,5*zeta1,'k--');
h1 = xlabel('time (m/s)');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
h1 = ylabel('$$z_{i,1}$$ (m)');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
h1 = legend('$$z_{1,1}$$','$$z_{2,1}$$','$$z_{3,1}$$','$$z_{4,1}$$');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
figure(14)
plot(t,z2(:,2),'r-',t,z2(:,4),'b-',t,z2(:,6),'g-',t,z2(:,8),'c-'); hold on 
plot(t,-5*zeta2,'k--',t,5*zeta2,'k--');
h1 = xlabel('time (m/s)');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
h1 = ylabel('$$z_{i,2}$$ (m)');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
h1 = legend('$$z_{1,2}$$','$$z_{2,2}$$','$$z_{3,2}$$','$$z_{4,2}$$');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
figure(15)
subplot(211),plot(t,Thetau1,'r-',t,Thetau2,'b-',t,Thetau3,'g-',t,Thetau4,'c-');
h1 = xlabel('time (m/s)');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
h1 = ylabel('$$\Theta_{ui}$$ (m)');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
h1 = legend('$$\Theta_{u1}$$','$$\Theta_{u2}$$','$$\Theta_{u3}$$','$$\Theta_{u4}$$');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
subplot(212),plot(t,Thetar1,'r-',t,Thetar2,'b-',t,Thetar3,'g-',t,Thetar4,'c-');
h1 = xlabel('time (m/s)');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
h1 = ylabel('$$\Theta_{ri}$$ (m)');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
h1 = legend('$$\Theta_{r1}$$','$$\Theta_{r2}$$','$$\Theta_{r3}$$','$$\Theta_{r4}$$');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
