function [y1, y2, f1, f2, emi, Gamma] = CS3tf( x0, tau, tau_w, ts )
...
v_bar = v+emi*r;
Gamma = m22*m33-m23^2;
f21 = (m22*v*r-d11*u+m23*r^2+tau_w(1))/m11;
f22 = (m11*u*r+d22*emi*r-d23*r+tau_w(2))/m22-d22*v_bar/m22;
f23 = ((m11*m22-m22^2)*u*v+(m11*m23-m23*m22)*u*r-m22*(d33*r+d32*v)+...
      m23*(d23*r+d22*v)+m22*tau_w(3)-m23*tau_w(2))/Gamma;
