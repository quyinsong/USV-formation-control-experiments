...
% USV states
USV1.x0 = [0 0 0 16 -3 60*pi/180]';
USV2.x0 = [0 0 0 10 -2 90*pi/180]';
USV3.x0 = [0 0 0 5 -5 80*pi/180]';
USV4.x0 = [0 0 0  0 -5 70*pi/180]';
...
for k=1:Ns
   ...
   if t == 0
      ...
      RO1 = 2; RO2 = 3; RO3 = 2;
      R1_up = RO1+3;  R2_up = RO2+3; R3_up = RO3+3; 
...
%    tau_w = [wk_u,wk_v,wk_r]';
   ...
   tau_w = [0.1*sin(0.1*t)+0.5*sin(0.05*t) 0.05*sin(0.05*t) ...
            0.1*sin(0.1*t)+0.1*sin(0.05*t)]';
%    tau_w = [0 0 0]';
...
%    [USV4.x,USV4.tau,USV4.f] = CS4( USV4.x0, USV4.tauc_etm, tau_w, ts);
   ...
   USV2.zeta_bar = [USV2.zeta(1),USV2.zeta(3)]';
   USV3.zeta_bar = [USV3.zeta(1),USV3.zeta(3)]';
   USV4.zeta_bar = [USV4.zeta(1),USV4.zeta(3)]';
   ...
   USV1.x_tf = [ USV1.x_bar, USV1.y_bar,USV1.x(6)]';
   USV2.x_tf = [ USV2.x_bar, USV2.y_bar,USV2.x(6)]';
   USV3.x_tf = [ USV3.x_bar, USV3.y_bar,USV3.x(6)]';
   USV4.x_tf = [ USV4.x_bar, USV4.y_bar,USV4.x(6)]';
...
%    pi4_dot = [x00_dot,y00_dot]';
   ...
   % ESO
   if t==0
      Kr = [20 30 50]'; Ku = [20 30 50]'; 
   end
   ww = 20;
   [USV1.eta_hat,USV1.nu_hat,USV1.zeta_hat] = ESO1(USV1.x_tf,USV1.tau,USV1.Gamma,ww,ts);
   [USV2.eta_hat,USV2.nu_hat,USV2.zeta_hat] = ESO2(USV2.x_tf,USV2.tau,USV2.Gamma,ww,ts);
   [USV3.eta_hat,USV3.nu_hat,USV3.zeta_hat] = ESO3(USV3.x_tf,USV3.tau,USV3.Gamma,ww,ts);
   [USV4.eta_hat,USV4.nu_hat,USV4.zeta_hat] = ESO4(USV4.x_tf,USV4.tau,USV4.Gamma,ww,ts);
   
   % Guidance
   hi = diag([1,delta0]);
   USV1.nu_c = Guidance1( hi, R_psi1, z2(1:2), pi1_dot, USV1.nu_hat(2));
   USV2.nu_c = Guidance2( hi, R_psi2, z2(3:4), pi2_dot, USV2.nu_hat(2));
   USV3.nu_c = Guidance3( hi, R_psi3, z2(5:6), pi3_dot, USV3.nu_hat(2));
   USV4.nu_c = Guidance4( hi, R_psi4, z2(7:8), pi4_dot, USV4.nu_hat(2));
   
%    USV1.nu_c = Guidance1( hi, R_psi1, z2(1:2), pi1_dot, USV1.v_bar);
%    USV2.nu_c = Guidance2( hi, R_psi2, z2(3:4), pi2_dot, USV2.v_bar);
%    USV3.nu_c = Guidance3( hi, R_psi3, z2(5:6), pi3_dot, USV3.v_bar);
%    USV4.nu_c = Guidance4( hi, R_psi4, z2(7:8), pi4_dot, USV4.v_bar);
 
   % Control
   USV1.zetahat = [USV1.zeta_hat(1),USV1.zeta_hat(3)]';
   USV2.zetahat = [USV2.zeta_hat(1),USV2.zeta_hat(3)]';
   USV3.zetahat = [USV3.zeta_hat(1),USV3.zeta_hat(3)]';
   USV4.zetahat = [USV4.zeta_hat(1),USV4.zeta_hat(3)]';
   [USV1.tauc,USV1.e_bar] = ctr1( USV1.nu_hat ,USV1.zetahat, USV1.nu_c, USV1.tau, USV1.tauc, USV1.Gamma, ts );
   [USV2.tauc,USV2.e_bar] = ctr2( USV2.nu_hat ,USV2.zetahat, USV2.nu_c, USV2.tau, USV2.tauc, USV2.Gamma, ts );
   [USV3.tauc,USV3.e_bar] = ctr3( USV3.nu_hat ,USV3.zetahat, USV3.nu_c, USV3.tau, USV3.tauc, USV3.Gamma, ts );
   [USV4.tauc,USV4.e_bar] = ctr4( USV4.nu_hat ,USV4.zetahat, USV4.nu_c, USV4.tau, USV4.tauc, USV4.Gamma, ts );

%    [USV1.tauc,USV1.e_bar] = ctr1( USV1.nu ,USV1.zeta_bar, USV1.nu_c, USV1.tau, USV1.tauc, USV1.Gamma, ts );
%    [USV2.tauc,USV2.e_bar] = ctr2( USV2.nu ,USV2.zeta_bar, USV2.nu_c, USV2.tau, USV2.tauc, USV2.Gamma, ts );
%    [USV3.tauc,USV3.e_bar] = ctr3( USV3.nu ,USV3.zeta_bar, USV3.nu_c, USV3.tau, USV3.tauc, USV3.Gamma, ts );
%    [USV4.tauc,USV4.e_bar] = ctr4( USV4.nu ,USV4.zeta_bar, USV4.nu_c, USV4.tau, USV4.tauc, USV4.Gamma, ts );
   ...
   xout(k,:) = [t,USV1.x', USV2.x', USV3.x', USV4.x', USV1.tau' USV2.tau' USV3.tau' USV4.tau',...
                ...
                Tk1',Tk2',Tk3',Tk4',eF1_norm,eF2_norm,eF3_norm,eF4_norm,eL1,eL2,USV1.nu_hat(1),USV1.nu_hat(2),...
                USV1.v_bar,USV1.zeta_bar',USV1.zetahat',USV1.e_bar',USV2.e_bar',USV3.e_bar',USV4.e_bar'];
...
USV1.v_bar = xout(:,77);
USV1.zeta_bar = xout(:,78:79);
USV1.zetahat = xout(:,80:81);
USV1.e_bar = xout(:,82:83);
USV2.e_bar = xout(:,84:85);
USV3.e_bar = xout(:,86:87);
USV4.e_bar = xout(:,88:89);
...
yrange=[-30 30 120]; xrange = [-30 30 120];
...
h1 = legend('$$\bar{e}_{1,r}$$','$$\bar{e}_{2,r}$$','$$\bar{e}_{3,r}$$','$$\bar{e}_{4,r}$$');
set(h1,'Interpreter','latex'); set(h1,'FontSize',fontsize); set(h1,'FontName',fontname);
set(h1,'FontWeight',fontweight);
