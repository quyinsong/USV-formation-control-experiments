function [U_k,J,Xhat]=NMPC1(X_k1,Xr_k1,Q_bar,R_bar,U0,N,tm,Nm,Ob)
...
ub =[];
if Nm==0
    [Uk_1,J_1]=fmincon('costfun1',U0,A,b,Aeq,beq,lb,ub,'confun1'); %非线性求解器
    KK1 = KK1+1;
end
J = J_1;
U_k = Uk_1;
