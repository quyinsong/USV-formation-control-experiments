...
if 6*(KK1-1)+6*(N+1)>Nrm1
    if 6*(KK1-1)+6<=Nrm1
        Xdk(1:Nrm1-6*(KK1-1),1) = Xd(6*(KK1-1)+1:Nrm1);
        Xdk(Nrm1-6*(KK1-1)+1:6*(N+1),1) = repmat(Xd(Nrm1-5:Nrm1,1),(N+1)-(Nrm1/6-(KK1-1)),1);
    else
        Xdk(1:6*(N+1),1) = repmat(Xd(Nrm1-5:Nrm1,1),N+1,1);
    end
else
    Xdk = Xd(6*(KK1-1)+1:6*(KK1-1)+6*(N+1),1);
end
